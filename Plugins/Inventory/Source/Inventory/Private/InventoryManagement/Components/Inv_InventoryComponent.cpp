...
void UInv_InventoryComponent::Server_AddNewItem_Implementation(UInv_ItemComponent* ItemComponent, int32 StackCount)
{
	...
	// TODO: Destroy the item component's owning actor after adding it to the inventory
}
	...
	int32 Remainder)
{
	...
	// TODO: Destroy item if remainder is zero.
	// If remainder is not zero, we need to update the item component's stack count
}
...
void UInv_InventoryComponent::ConstructInventory()
{
	...
	checkf(OwningController.IsValid(), TEXT("OwningController is null in UInv_InventoryComponent::ConstructInventory. Make sure the component is attached to a valid actor with a player controller."));
